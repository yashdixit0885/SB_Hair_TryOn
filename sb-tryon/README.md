...
- 📋 Story 1.7 (next) — `<ColorRender>` component, texture-preserving WebGL2
- 📋 Stories 1.8 → 8.7 — backlog (see [`sprint-status.yaml`](../_bmad-output/implementation-artifacts/sprint-status.yaml))
